            ...
            <div className='h-screen bg-slate-500'>
                ...
                <div className='-mt-12 h-screen flex justify-center items-center mx-auto container'>
                    ...
                    <form className='w-96'>
                        ...
                        <div className="mt-2">
                            <input type="file" className="form-control text-white bg-transparent text-xl p-3" />
                        </div>
                        ...
                        <h6 className='mt-2 xs:text-center xs:text-sm md:text-right md:text-lg'>Allready have an account?  <Link className='text-white'>Sign in</Link></h6>
